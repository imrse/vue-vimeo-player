...
* Added support for supplying vimeoUrl which will instantiate the player with url instead of id. Useful if video is protected by private link. ([f175285](https://github.com/dobromir-hristov/vue-vimeo-player/commit/f175285))
